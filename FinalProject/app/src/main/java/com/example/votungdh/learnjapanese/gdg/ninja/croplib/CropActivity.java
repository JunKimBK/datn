package com.example.votungdh.learnjapanese.gdg.ninja.croplib;

/**
 * Created by VoTungDH on 17/03/04.
 */
...
import com.example.votungdh.learnjapanese.gdg.ninja.croplib.utils.CropView;
import com.example.votungdh.learnjapanese.gdg.ninja.croplib.utils.FileUtils;
import com.example.votungdh.learnjapanese.gdg.ninja.croplib.utils.ImageResizer;
...
public class CropActivity extends Activity implements OnClickListener{
	...
	private void initData(){
		...
		if(extras != null){
			...
			mSourceUri = extras.getParcelable(Crop.Extra.IMAGE_SOURCE);
			mOutputUri = extras.getParcelable(Crop.Extra.IMAGE_OUTPUT);
